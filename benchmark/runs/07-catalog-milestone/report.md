...
| Parameter | Value |
|---|---|
| Start / end date | 2026-09-09T02:01:30.636001+04:00 / 2026-09-09T02:13:06.474314+04:00 |
...
In the final series, both systems respond to Target.getTargets after the WebSocket handshake. Each uses 10 fresh processes, alternating system order; warmup is excluded. Date: 2026-09-09T02:12:42.401367+04:00. The main series uses the same shared probe.
...
1. By median warm navigation→completion, Mimic is faster on: none of the measured workloads. CDP readiness (shared probe, separate cold runs): mimic 214.90 ms; chrome 278.03 ms

2. Chrome is faster by the same metric on: async (91.78 / 44.44 ms Mimic/Chrome); cpu (77.09 / 45.33 ms Mimic/Chrome); dom (111.15 / 48.13 ms Mimic/Chrome); react (85.88 / 41.22 ms Mimic/Chrome); static (44.18 / 20.65 ms Mimic/Chrome); wasm (51.44 / 22.48 ms Mimic/Chrome).

3. Fixed process overhead (CDP ready, including the initial page): mimic 25.45 MiB; chrome 388.09 MiB. Startup latency and the OLS intercept are reported separately above.

4. Estimated marginal RAM/session: chrome/cpu 74.47 MiB; mimic/cpu 29.74 MiB; chrome/react 70.68 MiB; mimic/react 23.51 MiB; chrome/static 59.67 MiB; mimic/static 18.60 MiB.
...
cpu, N=100: Mimic 52.11 and Chrome 24.56 successful sessions/s; RSS 3056.19 and 8737.82 MiB; CPU/session 328.00 and 181.94 ms.

react, N=100: Mimic 61.26 and Chrome 23.07 successful sessions/s; RSS 2440.05 and 8339.89 MiB; CPU/session 281.78 and 191.38 ms.

static, N=100: Mimic 91.53 and Chrome 28.63 successful sessions/s; RSS 1942.44 and 7075.75 MiB; CPU/session 171.00 and 121.59 ms.
