...
Fast gate DOM execution: 197.37 -> 156.11 ms (-20.9%); static completion 58.05 ms; React completion 103.97 ms. A slow DOM sample remains in the raw series (completion 325.42 ms); no sample was removed. Compared with frozen DOM execution 1560.32 ms this is approximately 10x, but the explicit <150 ms target remains narrowly unmet in this fast gate. The final full milestone matrix is required to confirm results.
