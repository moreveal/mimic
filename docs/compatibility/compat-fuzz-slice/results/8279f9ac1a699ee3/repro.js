...
return {status:'ok',value:await (other.eval('({self:window===globalThis,parentDifferent:parent!==window,ownObject:Object===window.Object,documentBrand:Object.prototype.toString.call(document)})'))};
} catch(e) {return {status:'exception',error:error(e)};}
})();
  for (const key of ["value", "documentBrand"]) {
