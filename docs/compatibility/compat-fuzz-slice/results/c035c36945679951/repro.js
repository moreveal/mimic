...
return {status:'ok',value:await (({differentObject:other.Object!==Object,sameProxy:other===frame.contentWindow,frameElement:other.frameElement===frame,parent:other.parent===window,document:other.document===frame.contentDocument,instance:other.document instanceof other.Document,notMainInstance:other.document instanceof Document}))};
} catch(e) {return {status:'exception',error:error(e)};}
})();
  for (const key of ["value", "frameElement"]) {
