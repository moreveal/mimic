...
func (e *QUICTransportParametersExtension) writeToUConn(uc *UConn) error {
	if uc.quic != nil && uc.quic.transportParams != nil {
		e.marshalResult = append([]byte{}, uc.quic.transportParams...)
	}
	return nil
}
