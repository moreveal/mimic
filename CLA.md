# Mimic Contributor License Agreement

Based on the Harmony Contributor Agreement Template, Version 1.0.

Thank you for your interest in contributing to Mimic ("We" or "Us").

This contributor agreement ("Agreement") documents the rights granted by
contributors to Us. To make this document effective, accept it through the CLA
Assistant check on a Mimic pull request. This is a legally binding document, so
please read it carefully before agreeing to it.
...
Copyright in the entire work of authorship, do not Submit it unless You have the
legal authority to grant the rights in this Agreement and clearly identify the
third-party material and its applicable terms in Your Submission.
...
"Material" means Mimic, the work of authorship which is made available by Us to
third parties. After You Submit the Contribution, it may be included in the
Material.
...
Contribution in the Material, We may license the Contribution under any license,
...
We will not use additional licenses for Media in the Contribution solely because
it is Media; the preceding paragraph applies to all Contributions.
...
(c) If You are an Individual, the grant of rights under Section 2 does not
violate any grant of rights which You have made to third parties, including Your
employer. If You are an employee, You have had Your employer approve this
Agreement or accept the Entity version of this Agreement. If You are less than
eighteen years old, Your parent or guardian must accept the Agreement.

(d) If You are an Entity, the grant of rights under Section 2 does not violate
any grant of rights which You or Your Affiliates have made to third parties.

(e) If You do not own the Copyright in the entire work of authorship Submitted,
You have followed the third-party-material instructions in the definition of
"Contribution."
...
You accept this Agreement electronically through the CLA Assistant check on a
pull request to `moreveal/mimic`. The GitHub account authenticated by CLA
Assistant identifies You for that acceptance. If You accept on behalf of a Legal
Entity, You represent that You have authority to bind that Entity and must
identify the Entity when accepting.

"Us" means `moreveal`, maintainer of Mimic.

---

This agreement is adapted from the Harmony Contributor Agreement Template,
Version 1.0. The Harmony template is licensed under the
[Creative Commons Attribution 3.0 Unported License](https://creativecommons.org/licenses/by/3.0/).
This adaptation is not endorsed by Project Harmony.
