...
const server = http.createServer((req, res) => {
  ...
  res.end('<!doctype html><title>Automation fixture</title><h1>Fixture</h1><label>Name<input id="name"></label><button onclick="document.querySelector(\'h1\').textContent=document.querySelector(\'input\').value">Apply</button>');
});
