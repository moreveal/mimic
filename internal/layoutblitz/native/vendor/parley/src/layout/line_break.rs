            ...
            match line_item.kind {
                LayoutItemKind::InlineBox => {
                    ...
                    if item.kind == InlineBoxKind::InFlow {
                        ...
                        line.metrics.ascent = line.metrics.ascent.max(item.height - below);
                        line.metrics.descent = line.metrics.descent.max(below);
                        line.metrics.line_height = line.metrics.line_height.max(line.metrics.ascent + line.metrics.descent);
