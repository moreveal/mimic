...
pub(crate) struct LayoutData<B: Brush> {
    ...
    /// Optional CSS parent strut: ascent, descent, and used line height.
    pub(crate) line_strut: Option<[f32; 3]>,
    /// The `BiDi` base level
    ...
    pub(crate) inline_box_baseline_offsets: Vec<f32>,
...
impl<B: Brush> Default for LayoutData<B> {
    fn default() -> Self {
        Self {
            ...
            inline_box_baseline_offsets: Vec::new(),
            runs: Vec::new(),
            items: Vec::new(),
            clusters: Vec::new(),
            glyphs: Vec::new(),
...
impl<B: Brush> LayoutData<B> {
    pub(crate) fn clear(&mut self) {
        ...
        self.inline_box_baseline_offsets.clear();
        self.runs.clear();
        self.items.clear();
        self.clusters.clear();
        self.glyphs.clear();
