...
// events. Listener records belong to their EventTarget, never a global Page.
{
  ...
  for(const [name,source] of [['x','clientX'],['y','clientY'],['offsetX','clientX'],['offsetY','clientY']])accessor(MouseEvent.prototype,name,function(){return this[source]});
  accessor(MouseEvent.prototype,'pageX',function(){return this.clientX+window.scrollX});
  accessor(MouseEvent.prototype,'pageY',function(){return this.clientY+window.scrollY});
